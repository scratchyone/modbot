      ...
      responder: async (
        ...
        if (
          ...
          for (const morb of util_functions.shuffle([
            ...
            'vriska',
            'norris',
            '',
            'fartmachine',
            'yuri',
            'minecraft',
            'yourmom',
