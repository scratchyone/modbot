...
alpha -> "alpha"i __ anything {% n => {return {command: "alpha", text: n[2]}} %}
...
note -> ("warn"i | "note"i) __ user __ anything {% (n)=>{return {command: n[0][0], user: n[2], text: n[4]}}%}
...
suggestion -> "suggestion"i {% (n)=>{return {command: "suggestion"}}%}
