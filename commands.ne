...
| purge | setupmute | mute | unmute | usercard | note | forgive | invite | userpic | ping | alertchannel | cat | joinroles | eval | stats | update
) {% n => n.slice(2)[0] %}
...
mute -> "mute" __ user (__ word):? {% (n)=>{return {command: "mute", user: n[2], duration: n[3] ? n[3][1] : null}}%}
