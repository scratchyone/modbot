...
reminder -> ("reminder" | "rm") __ (("add" __ word __ anything) | ("cancel" __ word) | ("copy" __ word) ) {% (n)=>{return {command: "reminder", time: n[2][0][0] == "add" ? n[2][0][2] : undefined, text: n[2][0][0] == "add" ? n[2][0][4] : undefined, action: n[2][0][0], id: n[2][0][0] == "cancel" || n[2][0][0] == "copy" ? n[2][0][2] : undefined}}%}
