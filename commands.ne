...
unlockdown | poll | color | automod | slowmode | suggestion | prefix | embed | addemoji | support | ticket | announce | spoil | pick
) {% n => n[0] %}
...
reminder -> ("reminder" | "rm" | "reminders") __ (("add" __ word __ anything) | ("list") | ("cancel" __ word) | ("copy" __ word) ) {% (n)=>{return {command: "reminder", time: n[2][0][0] == "add" ? n[2][0][2] : undefined, text: n[2][0][0] == "add" ? n[2][0][4] : undefined, action: n[2][0][0], id: n[2][0][0] == "cancel" || n[2][0][0] == "copy" ? n[2][0][2] : undefined}}%}
...
color -> ("color" | "colour") __ anything {% n => {return {command: "color", color: n[2]}} %}
